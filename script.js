...
// Reusable currency formating function
...
const startLotOutTimer = function () {
  const tick = function () {
...
btnTransfer.addEventListener('click', function (e) {
  ...
  if (
    ...
    // Reset timer if we transfer something
    clearInterval(timer);
    timer = startLotOutTimer();
  }
});
